...
urlpatterns = [
    ...
    path('movies/watched', views.Watched_Movie_List.as_view(),name='watched-movie-view'),
    path('movies/watch_list', views.Watch_List_List.as_view(),name='watchlist-movie-view'),
